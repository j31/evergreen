...
$(document).ready(function() {
 ...
 { _id: 18, group: "Arts", category: "Classical Music", imgFileName: "cat_clas_music.jpg" }
  ...
  Explore.prototype.getCategoryChoices = function () {
    ...
    var zeroStrengthTerms = app.user.knowledge.filter( t => t.strength === 0 )
    console.log(zeroStrengthTerms)

    // Find unique categories where user has new terms
  ...
  Explore.prototype.showQuickScanTerms = function () {
    ...
    console.log("termsInCategory ", termsInCategory)
